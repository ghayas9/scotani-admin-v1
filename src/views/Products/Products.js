                                        ...
                                        <Row>
                                            <Col xl={3} sm={6}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Control type="text" onKeyPress={handleKeyPress} value={searchName} placeholder="Name" onChange={(e) => setSearchName(e.target.value)} /*onKeyDown={} */ />
                                                </Form.Group>
                                            </Col>
                                            ...
                                            <Col xl={3} sm={6}>
                                                ...
                                                <Form.Group>
                                                    <Form.Label style={{ color: 'black' }} className="d-block mb-2">Type</Form.Label>
                                                    <select value={searchType} onKeyPress={handleKeyPress} onChange={(e) => setSearchType(e.target.value)}>
                                            ...
                                            <Col xl={3} sm={6}>
                                                <Form.Group className='btnGroup'>
                                                    ...
                                                    <div className="d-flex filter-btns-holder">
                                                        <Button variant="info" disabled={!searchName && !category && !searchType && !searchStatus} onClick={applyFilters}>Search</Button>
                                                        <Button variant="warning" hidden={!searchName && !category && !searchType && !searchStatus} onClick={reset}>Reset</Button>
                                                    </div>
                                                </Form.Group>
                                            </Col>
                                        </Row>
                                    ...
                                    <Card.Body className="table-full-width">
                                        <div className="table-responsive">
                                            <Table className="table-bigboy">
                                                <thead>
                                                    <tr>
                                                        <th className="text-center serial-col" style={{ width: "10%" }}>#</th>
                                                        <th className="text-center" style={{ width: "10%" }} >Product Image</th>
                                                        <th className="text-center" style={{ width: "30%" }} >Product Name</th>
                                                        <th className="text-center" style={{ width: "10%" }} >Category</th>
                                                        <th className="text-center" style={{ width: "10%" }} >Product Type</th>
                                                        ...
                                                        products && products.length ?
                                                                ...
                                                                return (
                                                                    <tr key={index}>
                                                                        ...
                                                                        <td className="text-center">
                                                                            <div className="user-image text-center" style={{ margin: "auto" }}>
                                                                        ...
                                                                        <td className="text-center">
                                                                            {item.price ? currencyFormat(item.price) : "N/A"}
                                                                        </td>
                                                                            ...
                                                                            <ul className="list-unstyled mb-0">
                                                                                {
                                                                                    ...
                                                                                    <li className="d-inline-block align-top">
                                                                                        <Button
                                                                                            ...
                                                                                            variant="success"
                                                                                            onClick={() => props.history.push(`/edit-product/${item._id}`)}
                                                                                        >
                                                                                ...
                                                                                }
                                                                                {
                                                                                    ...
                                                                                    item.type == 3 && permissions && permissions.editProduct &&

                                                                                    <li className="d-inline-block align-top">
                                                                                        <Button
                                                                                            className="btn-action btn-warning"
                                                                                            type="button" title="Edit Variations"
                                                                                            variant="warning"
                                                                                            onClick={() => props.history.push(`/list-variations/${item._id}`)}
                                                                                        >
                                                            ...
                                                            <tr>
                                                                <td colSpan="8" className="text-center">
                                                                    <div className="alert alert-info" role="alert">No Product Found</div>
                                                                </td>
                                                            </tr>
                                                    }
                                                </tbody>
...
export default connect(mapStateToProps, { beforeProduct, deleteProduct, getProducts, getRole, getCategories, beforeCategory })(Products);