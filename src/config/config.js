...
module.exports = {
    ...
    ENV: {
        ...
        uploadedImgPath: `${process.env.REACT_APP_BASE_URL}images/`,
        invoicePath: `${process.env.REACT_APP_BASE_URL}invoices/`,
        quotationPath: `${process.env.REACT_APP_BASE_URL}quotations/`,
        reportPath: `${process.env.REACT_APP_BASE_URL}reports/`,
